...
load_path = 'E:\\Deep Learning Datasets\\UrbanSound8K\\extracted_long'
train_dirs = []
n_folders = 10
...
model = load_model('E:\\Deep Learning Datasets\\long60_150_(8, 9).h5')    
...
utils.save_confusion_matrix(confusion_matrix, classes, title='long60_150_(8, 9)')
